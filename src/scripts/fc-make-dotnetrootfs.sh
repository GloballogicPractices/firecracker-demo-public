...
# download rootfs
curl -fsSL -o ./images/dotnet-rootfs.ext4 https://s3.amazonaws.com/spec.ccfc.min/img/hello/fsfiles/hello-rootfs.ext4

# resize ext4 volume
sudo e2fsck -f ./images/dotnet-rootfs.ext4
sudo resize2fs ./images/dotnet-rootfs.ext4 256M
